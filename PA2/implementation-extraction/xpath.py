...
def run_xpath():
    ...
    f = open(os.path.join(out, f"rtvslo_xpath.json"), "w", encoding='utf8')
    rtv_out = {
        "Audi": rtvslo1,
        "Volvo": rtvslo2
    }
    ...
    f = open(os.path.join(out, f"overstock_xpath.json"), "w", encoding='utf8')
    overstock_out = {
    ...
    f = open(os.path.join(out, f"zurnal24_xpath.json"), "w", encoding='utf8')
    zurnal_out = {
        "Subvencije": zurnal1,
        "Dars": zurnal2
    }
